              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {skills.map((skill, index) => {
                  ...
                  return (
                    <motion.div
                      key={skill.title}
                      className="p-6 rounded-xl bg-gradient-to-br from-primary-50 to-purple-50 border border-primary-100 hover:shadow-lg transition-all"
                    ...
                    >
                      ...
                      <h4 className="text-lg font-semibold mb-2 text-gray-900">{skill.title}</h4>
